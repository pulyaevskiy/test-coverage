...
void main() {
  String stubRoot = path.join(Directory.current.path, 'test', 'stub_package');
  group('findTestFiles', () {
    test('finds only test files', () {
      final result = findTestFiles(new Directory(stubRoot));
  ...
  group('generateMainScript', () {
    final file = new File(path.join(stubRoot, 'test', '.test_coverage.dart'));
...
''';
  ...
  group('$TestFileInfo', () {
    test('for file', () {
      final a = new File(path.join(stubRoot, 'test', 'a_test.dart'));
    ...
    test('for nested file', () {
      final b = new File(path.join(stubRoot, 'test', 'nested', 'b_test.dart'));
